...
import { ArrowLeft, Calendar, User, Check, Circle, ChevronLeft, AlertCircle, RotateCcw, ShieldCheck, Mail, Send, Ban, Trash2, Menu, X, } from "lucide-react";
          ...
          {PHASES.map((phase) => (
            <div key={phase.id} className="mb-1">
              ...
              {STEP_DEFS.map((s, idx) => {
                ...
                return (
                  <button key={idx} disabled={!reachable} onClick={() => { setViewIndex(idx); setMobileNavOpen(false); }}
